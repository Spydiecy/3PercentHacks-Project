                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <img
                                        ...
                                        src="https://raw.githubusercontent.com/Spydiecy/Astra_TRN/refs/heads/main/public/hero.png?token=GHSAT0AAAAAAC3HREOVV4ILR3OYH2BNVGME2CBLBZQ"
                                        alt="app screen"
                                        width="2700"
                                        height="1440"
                                    />
                    ...
                    <div className="mx-auto max-w-7xl px-6">
                        <div className="grid items-center gap-12 lg:grid-cols-2">
                            ...
                            <div className="rounded-xl border p-4">
                                <img 
                                    src="https://raw.githubusercontent.com/Spydiecy/Astra_TRN/refs/heads/main/public/ai.png?token=GHSAT0AAAAAAC3HREOUJ4C75BZ2PYTBMPWS2CBLBYQ" 
